...
Description:	Data loading pipeline inherited from `torch.utils.data.Dataset`. Returns a tensor dataset.
...
class CQ500Dataset(torch.utils.data.Dataset):
	...
	"""
	def __init__(self, manifest_df:DataFrame, labels_df:DataFrame, transform=None) -> None:
		"""
...
def to_windowed_tensor(
		...
		out_size: tuple[int, int] | None = (256, 256),
